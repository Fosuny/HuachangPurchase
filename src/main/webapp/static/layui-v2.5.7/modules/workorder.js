    ...
    function(e){
         ...
         i.render({
             ...
             cols:[[{type:"numbers",fixed:"left"},
                 {field:"orderid",width:100,title:"项目编号",sort:!0},
                 {field:"attr",width:100,title:"产品名称"},
                 {field:"title",width:100,title:"数量",width:300},
                 {field:"progress",title:"进度",width:200,align:"center",templet:"#progressTpl"},
                 {field:"submit",width:100,title:"单价"},
                 {field:"accept",width:100,title:"总价"},
                 {field:"state",title:"项目状态",templet:"#buttonTpl",minWidth:80,align:"center"},
                 {field:"date",title:"审核时间",templet:"#buttonTpl",minWidth:80,align:"center"},
